...
public class tc001_busquedaCampoIncompleto extends TestBase{
    ...
    public void atc01(){
        ...
        trasladosPage.enterDataFieldTo(fieldTo,"Sheraton Pilar",localizadorTo, "Sheraton Pilar Hotel & Convention Center, Pilar, Provincia de Buenos Aires, Argentina");
        trasladosPage.selectDateAndSearch(FechaElegida, "Mar, 21 sep 2021");
