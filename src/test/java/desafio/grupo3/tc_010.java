...
public class tc_010 {
    ...
    public void test() throws InterruptedException {
        ...
        //comparar
        By llegada = By.xpath("//p[@class='eva-3-p eva-3-body-2']");
        exwait.until(ExpectedConditions.elementToBeClickable(llegada));
        WebElement puntoLlegada = driver.findElement(llegada);
        WebElement puntoPartida = driver.findElement(By.id("transfer-pickup-T0"));


        if (puntoPartida.getText().contains("")|| puntoLlegada.getText().contains(hotel)){
